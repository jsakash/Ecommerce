...
// 		orders := models.Orders{UsersID: userID, AddressID: uint(addressID), OrderID: orderID, Discount: discount, CouponDiscount: couponDiscount, CouponCode: couponCode, Payment_Method: cod, Total_Amount: total, OrderStatus: OrderStatus}
...
// 		orders := models.Orders{UsersID: userID, AddressID: uint(addressID), OrderID: orderID, Discount: discount, CouponDiscount: couponDiscount, CouponCode: couponCode, Payment_Method: RazorPay, Total_Amount: total, OrderStatus: OrderStatus}
// 		database.DB.Create(&orders)
// 	}

// }

// // func InstantOrder(uid uint, pid uint, oid string, dis int) {
// // 	usersID := uid
// // 	PID := pid
// // 	OID := oid
// // 	Disc := dis
// // 	var product models.Products
// // 	database.DB.First(&product, PID)
// // 	Pname := product.Product_Name
// // 	price := product.Product_Price
// // 	Sprice := product.Product_Price - Disc
// // 	status := "CONFIRMED"
// // 	ordereditems := models.Ordereditems{UsersID: usersID, ProductsID: PID, Order_ID: OID, Product_Name: Pname, Price: price, SellingPrice: Sprice, Discount: Disc, Status: status}
